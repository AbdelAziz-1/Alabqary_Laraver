  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var lt = function() {
      ...
      return r(t2, [{ key: "init", value: function() {
        ...
        if (g2.height = 2 * (l2 + d2) + "px", g2.width = 2 * (l2 + d2) + "px", g2.left = h2 + "px", g2.top = c2 + "px", s2.config.legend.markers.customHTML) g2.background = "transparent", g2.color = a2[i2], Array.isArray(s2.config.legend.markers.customHTML) ? s2.config.legend.markers.customHTML[i2] && (r2.innerHTML = s2.config.legend.markers.customHTML[i2]()) : r2.innerHTML = s2.config.legend.markers.customHTML();
          ...
          var u2 = new D(this.ctx).getMarkerConfig({ cssClass: "apexcharts-legend-marker apexcharts-marker apexcharts-marker-".concat(n2), seriesIndex: i2, strokeWidth: d2, size: l2 }), p2 = SVG(r2).size("100%", "100%"), f2 = new m(this.ctx).drawMarker(0, 0, e(e({}, u2), {}, { pointFillColor: Array.isArray(s2.config.legend.markers.fillColors) ? a2[i2] : u2.pointFillColor, shape: n2 }));
    ...
    var vt = function() {
      ...
      return r(t2, [{ key: "handleBarDataLabels", value: function(t3) {
        ...
        var E2 = { x: e2, y: i2, i: r2, j: o2, realIndex: n2, columnGroupIndex: l2, renderedPath: x2, bcx: h2, bcy: c2, barHeight: d2, barWidth: g2, textRects: z2, strokeWidth: y2, dataLabelsX: A2, dataLabelsY: S2, dataLabelsConfig: L2, barDataLabelsConfig: P2, barTotalDataLabelsConfig: M2, offX: I2, offY: T2 };
        return C2 = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(E2) : this.calculateColumnsDataLabelsPosition(E2), x2.attr({ cy: C2.bcy, cx: C2.bcx, j: o2, val: b2.globals.series[r2][o2], barHeight: d2, barWidth: g2 }), w2 = this.drawCalculatedDataLabels({ x: C2.dataLabelsX, y: C2.dataLabelsY, val: this.barCtx.isRangeBar ? [a2, s2] : b2.globals.series[r2][o2], i: n2, j: o2, barWidth: g2, barHeight: d2, textRects: z2, dataLabelsConfig: L2 }), b2.config.chart.stacked && M2.enabled && (k2 = this.drawTotalDataLabels({ x: C2.totalDataLabelsX, y: C2.totalDataLabelsY, barWidth: g2, barHeight: d2, realIndex: n2, textAnchor: C2.totalDataLabelsAnchor, val: this.getStackedTotalDataLabel({ realIndex: n2, j: o2 }), dataLabelsConfig: L2, barTotalDataLabelsConfig: M2 })), { dataLabels: w2, totalDataLabels: k2 };
