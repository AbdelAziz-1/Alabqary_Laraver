@extends('layouts.vertical', ['title' => isset($course) ? 'Edit Course' : 'Create a New Course'])
        ...
        <form action="{{ isset($course) ? route('courses.update', $course->id) : route('courses.store') }}"
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ isset($courses) ? 'Edit Course' : 'Create a New Course' }}</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <button type="button" id="add-video" class="btn btn-outline-primary btn-sm mt-2">Add
                                    Video</button>
                            </div>
                        </div>
                    </div>
